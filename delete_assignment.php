<?php
header( "refresh:2; url=http://schedulizer.web.engr.illinois.edu/view_assignment.php" );
...
$sql = "DELETE FROM tab_assignment WHERE assignment_id='$id'";
$result = mysqli_query($con, $sql);

echo "Assignment deleted.<br><br>";
