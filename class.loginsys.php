...
class LoginSystem {
	/* Start Config */
	private $dbhost 		= "engr-cpanel-mysql.engr.illinois.edu";	// Host Name
	private $dbport 		= "";	//Port
	private $dbuser 		= "scheduli_d";	// MySQL Database Username
	private $dbpass 		= "12345";	// MySQL Database Password
	private $dbname 		= "scheduli_data";	// Database Name
	private $dbtable 		= "tab_users";	// Your Users Table
	...
	private $company		= "CS411";	// Company for name for including in emails
	...
	public $staticPages	= array(
				"/", "/index.php", "/resetpass.php", "/register.php"
			...
			if( $sql->rowCount()==0 || $_POST['token']=="" ){
				...
				if( $_POST['password'] != $_POST['password2'] || $_POST['password']=="" || $_POST['password2']=="" ){
					...
					if( $this->changePassword($this->secureKey) ){
						...
						echo "<a href='http://schedulizer.web.engr.illinois.edu/login.php'>Click here to login</a>";
	...
	public function changePassword($parent = ""){
		...
		if($this->loggedIn){
			if(false){//isset($_POST['logSysChangePassword']) && $parent == $this->secureKey && isset($_POST['newPassword']) && $_POST['newPassword'] != "" && $_POST['newPassword'] == $_POST['newPassword2'] ){
				$randomSalt	= $this->rand_string(20);
				...
				echo "broham";
				echo "<a href='http://schedulizer.web.engr.illinois.edu/changepass.php'>Go Back</a>";
				return true;
				...
				$html = "<form action='".$_SERVER['PHP_SELF']."' method='POST'>";
					...
					$html .= "<button name='logSysChangePassword' type='submit'>Change Password</button><br>";
					$html .= "<a href='http://schedulizer.web.engr.illinois.edu/main_menu.php'>Return Home</a>";
				$html .= "</form>";
				echo $html;
				...
				if( isset($_POST['newPassword']) && $_POST['newPassword']!="" && isset($_POST['newPassword2']) && $_POST['newPassword2']!="" && isset($_POST['curpass']) && $_POST['curpass']!="" ){
					...
					if($this->login($curuserUsername, $curpass, false)){
						if($newPassword != $newPassword2){
							...
							echo "<a href='http://schedulizer.web.engr.illinois.edu/main_menu.php'>Return Home</a>";
					...
					echo "<h3>Error : Password Fields were blank</h3>";
					echo "<a href='http://schedulizer.web.engr.illinois.edu/changepass.php'>Go Back</a>";
			...
			echo "<a href='http://schedulizer.web.engr.illinois.edu/login.php'>Login</a>";
