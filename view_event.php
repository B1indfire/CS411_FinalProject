...
$result = mysqli_query($con,"SELECT * FROM tab_event where name != ''AND date >= curdate() AND user = '$loggedInUser' order by date");
...
$sql = "SELECT * FROM tab_event where name != '' AND date>= curdate() AND user = '$loggedInUser' order by date";
