...
$result = mysqli_query($con,"SELECT * FROM tab_exam WHERE user = '$loggedInUser' AND date >= curdate()order by date");
?>
...
while($row = mysqli_fetch_array($result)) {
  echo "<tr>";
  echo "<td>" . $row['class_name'] . " " . $row['exam_name'] . "</td>";
...
echo "<form action='delete_exam.php' method='post'>";
